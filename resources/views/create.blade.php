        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-10">
            <div>
                <h1 class="text-4xl font-extrabold text-slate-900 tracking-tight">
                    Ajouter un <span class="text-gradient">Nouvel Étudiant</span>
                </h1>
                <p class="mt-2 text-slate-600 text-lg">Inscrivez un étudiant dans l'annuaire académique.</p>
            </div>
            ...
            <form action="{{ route('store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="name" name="name" placeholder="Entrez le nom de l'étudiant" required>
                </div>
                ...
                <div>
                    ...
                    <input type="email"
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 placeholder-slate-400"
                        id="email" name="email" placeholder="exemple@universite.com" required>
                </div>
